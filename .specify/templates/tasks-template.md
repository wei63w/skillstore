...
- [ ] T009A Implement checkpoint/resume persistence for long-running agent work
  (if Agent Dev Harness is touched)
- [ ] T009B Define human confirmation gate handling for ambiguity, high-risk
  infrastructure, permission, credential, payment, privacy, and security events
- [ ] T009C Configure Docker build, environment isolation, smoke validation, and
...
- [ ] T011A [P] [US1] Unit tests for core service behavior in tests/unit/test_[name].py
- [ ] T011B [P] [US1] E2E test for [core user flow] in tests/e2e/[name].spec.[ext]
- [ ] T011C [P] [US1] Security and validation tests for auth, RBAC, inputs, and file handling
...
- [ ] T019A [P] [US2] Unit, E2E where applicable, and security tests for [feature]
...
- [ ] T025A [P] [US3] Unit, E2E where applicable, and security tests for [feature]
...
- [ ] TXXX [P] Coverage report proving unit coverage is at least 80%
- [ ] TXXX Security hardening and high-risk vulnerability remediation
- [ ] TXXX [P] SAST and dependency vulnerability scan report
...
- Tests MUST be written and FAIL before implementation unless explicitly marked
  not applicable in spec.md
